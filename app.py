...
def analyze_with_ai(text):
    ...
    try:
        ...
        2. Suggest 3 suitable job roles containing a title and description.
        3. Calculate an estimated ATS Score (0-100).
        4. Provide 3 specific tips to improve the resume.
        5. Identify 3 critical MISSING skills for the suggested roles and provide a brief recommendation on how to verify/learn them.
